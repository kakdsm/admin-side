...
$removeAdminImage = isset($_POST['removeAdminImage']) && $_POST['removeAdminImage'] == '1'; 
...
try {
    ...
    $_SESSION['profile_message'] = 'Error updating profile: ' . $e->getMessage(); 
